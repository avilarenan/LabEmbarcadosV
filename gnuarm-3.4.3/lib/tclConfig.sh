...
# installed.
TCL_PREFIX='/srv/shared/gnuarm/gnuarm-3.4.3'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/srv/shared/gnuarm/gnuarm-3.4.3'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/srv/shared/gnuarm/insight-build/tcl/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/srv/shared/gnuarm/gnuarm-3.4.3/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/srv/shared/gnuarm/gnuarm-3.4.3/include'
...
# compiled.
TCL_SRC_DIR='/srv/shared/gnuarm/insight-6.1/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/srv/shared/gnuarm/gnuarm-3.4.3/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/srv/shared/gnuarm/insight-build/tcl/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/srv/shared/gnuarm/gnuarm-3.4.3/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/srv/shared/gnuarm/insight-build/tcl/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/srv/shared/gnuarm/gnuarm-3.4.3/lib/libtclstub8.4${TCL_DBGX}.a'
